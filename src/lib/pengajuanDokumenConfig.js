...
export const DOKUMEN_CONFIGS = [
    ...
    fields: [
      {
        ...
        aliases: ['surat_pindah', 'surat_keterangan_pindah', 'file_surat_pindah'],
        label: 'Surat Keterangan Pindah',
        required: true,
        ...PDF_PNG,
      },
      { key: 'pasFoto', backendKey: 'pas_foto_3x4', aliases: ['pas_foto', 'pasfoto'], label: 'Pas Foto 3x4', required: true, ...PDF_PNG },
      { key: 'kartuKeluarga', backendKey: 'kartu_keluarga', aliases: ['kk'], label: 'Fotocopy dan Asli KK', required: true, ...PDF_PNG },
      { key: 'ktp', backendKey: 'ktp', aliases: ['fotocopy_ktp'], label: 'Fotocopy KTP', required: true, ...PDF_PNG },
      {
        key: 'aktaKelahiranWniTionghoa',
        backendKey: 'akta_kelahiran_wni_tionghoa',
        aliases: ['akta_kelahiran'],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'fotoLokasiTanah', backendKey: 'foto_lokasi_tanah', aliases: ['foto_lokasi'], label: 'Foto Lokasi Tanah', required: true, ...PDF_PNG },
      { key: 'buktiPbb', backendKey: 'bukti_pbb', aliases: ['pbb'], label: 'Bukti/Fotocopy PBB', required: true, ...PDF_PNG },
    ],
  },
  {
    ...
    fields: [
      { key: 'ktp', backendKey: 'ktp', aliases: ['fotocopy_ktp'], label: 'Fotocopy KTP', required: true, ...PDF_PNG },
      { key: 'kkAhliWaris', backendKey: 'kk_ahli_waris', aliases: ['kk'], label: 'Fotocopy KK Ahli Waris', required: true, ...PDF_PNG },
      {
        key: 'suratKematian',
        backendKey: 'surat_keterangan_kematian_kelurahan',
        aliases: ['surat_keterangan', 'surat_kematian'],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'ktpPengurus', backendKey: 'ktp_pengurus', aliases: ['ktp'], label: 'Fotocopy KTP Pengurus', required: true, ...PDF_PNG },
      { key: 'aktaNotaris', backendKey: 'akta_notaris_pendirian', aliases: ['akta_notaris'], label: 'Akta Notaris Pendirian', required: true, ...PDF_PNG },
    ],
  },
]
